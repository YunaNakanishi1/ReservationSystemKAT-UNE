...
<div id="slider-area">
        ...
        <br>
        <div id="slider-box" style="padding-left: 0px; padding-bottom:0px;">
        <div id="slider"></div>
        </div>
...
<% if(("-----").equals(session.getAttribute("coReservedPersonNameForReservationRegist"))) {
...
<input type="hidden" name="coReservedPersonId" id ="coReservedPersonId" value="${coReservedPersonIdForReservationRegist}"/>
</td>
</tr>
...
<textarea id="supplementArea" class="scroll5" name="supplement"onkeyup="ShowLength();" ><c:out value="${reserveSupplementForReservationRegist }"/></textarea><span id="inputlength">0/500</span>
