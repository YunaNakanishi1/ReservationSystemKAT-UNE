...
<td class="right2">
<textarea id="supplementArea" class="scroll2" name="reserveSupplement"onkeyup="ShowLength();" <c:out value="${reserveSupplementForReservationChange}"/> ><c:out value="${reserveSupplementForReservationRegist }"/></textarea><span id="inputlength">0/500</span>
</td>
</tr>
