...
<body>
	...
	<div class="div">
		...
		<div class="contents">
			...
			<h2>リソース一覧</h2>
			<p>
				<font color="blue">${Pmessage}</font>
			</p>
			<p>
				<font color="red">${Emessage}</font>
			</p>
			<p>
			<form method="post" name="form1" action="showfirstreservationlist">
    <a href="javascript:form1.submit()">予約一覧に戻る</a>
</form>
			</p>
			...
			<c:if test="${resourceListSize != 0}">
				<table id="design-table" class="table table-striped table-bordered"
					style="width: 90%">
					<thead>
						<tr>
							<th>リソース名</th>
					...
					<tbody>
						...
						<c:forEach var="obj" items="${resourceList}" varStatus="status">
							<tr>
								...
								<td class="the_number_of_characters_cut"><c:out
										value="${obj.supplement}" /></td>
